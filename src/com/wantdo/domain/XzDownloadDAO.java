 ...
 */
public class XzDownloadDAO extends HibernateDaoSupport {
	...
	public static XzDownloadDAO getFromApplicationContext(ApplicationContext ctx) {
		return (XzDownloadDAO) ctx.getBean("XzDownloadDAO");
	}
}