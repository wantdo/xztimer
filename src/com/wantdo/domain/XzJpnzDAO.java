 ...
 */
public class XzJpnzDAO extends HibernateDaoSupport {
	...
	public static XzJpnzDAO getFromApplicationContext(ApplicationContext ctx) {
		return (XzJpnzDAO) ctx.getBean("XzJpnzDAO");
	}
}